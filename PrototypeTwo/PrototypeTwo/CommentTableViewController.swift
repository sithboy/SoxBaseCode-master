...
class CommentTableViewController: UITableViewController {
    ...
    let commentArray = ["The top of the tram is really windy right now.", "Wilber has great snow", "The snow near the bottom is pretty slushy"]
    let timeArray = ["Mar 21 10:15 am", "Mar 21 9:30 am", "Mar 20 3:37 pm"]
